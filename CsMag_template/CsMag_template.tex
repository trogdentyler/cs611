...
\begin{document}
\setcounter{page}{1}
\title{PAPER TITLE HERE: No More Than Four Lines}
...
\markboth{ABBREVIATED PAPER TITLE HERE}{} %only abbreviate if title is longer than 2 lines on first page, otherwise use full title
...
beginning of a sentence: ``Reference \cite{kay2001logical} shows $\ldots$ .'' Please use the
provided refrence document for references instead of typing them in yourself.
...
\begin{wrapfigure}{l}{0.16\textwidth}
  \centering
  \vspace{-5mm}
  \includegraphics[width=0.18\textwidth]{ID-photo.jpg} %this ID photo should be the same as the one for your student ID, this way size is uniform.
  \vspace{-10mm}                                                      %If you do not know how to obtain your officially submitted student ID photo, leave blank.
\end{wrapfigure}\begin{IEEEbiography}{Michael DeBuse}{\,} is TA and editor for this course... Bibliography information here.
\end{IEEEbiography}
